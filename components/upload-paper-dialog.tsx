        ...
        {mode === "file" ? (
          <form onSubmit={handleUpload} className="space-y-4">
            ...
            <div className="space-y-1.5">
                <p className="text-sm text-muted-foreground">Title <span className="opacity-50">(optional)</span></p>
                <Input
                  type="text"
          ...
          <form onSubmit={handleArxivSubmit} className="space-y-4">
            <div className="space-y-3 py-4">
              <div className="space-y-1.5">
                <p className="text-sm text-muted-foreground">arXiv URL or paper ID</p>
                <Input
                  type="text"
            ...
            <div className="flex gap-2 justify-end pt-4">
              ...
              <Button type="submit" disabled={isLoading || !arxivInput.trim()}>
                {isLoading ? (
                  <><LoaderCircle className="h-4 w-4 animate-spin mr-1" /> Importing...</>
                ) : (
                  "Import Paper"
                )}
              </Button>
